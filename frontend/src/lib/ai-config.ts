...
// Using Qwen 2.5 Coder 32B PAID - BEST for structured data extraction (JSON, parsing)
// Specifically trained for code and structured output - perfect for resume parsing
// NO rate limits on paid tier, excellent at following JSON schemas
export const AI_MODEL = 'qwen/qwen-2.5-coder-32b-instruct';
